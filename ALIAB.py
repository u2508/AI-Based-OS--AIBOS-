...
def get_resolution():
    ...
    if monitors:
        ...
        return None
api = "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"
class SettingsDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.setStyleSheet(open('aliab_style.css').read())
...
class VoiceBotGUI(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.notes_button = QPushButton("Ai with Notes\nResearch Mode", settings_frame)
        self.notes_button.setGeometry(30, 100, 300, 120)
        ...
        self.keyboard_button.setGeometry(50, 260, 260, 120)
        self.keyboard_button.setFont(QFont("Helvetica", 32))
        self.keyboard_button.clicked.connect(self.SP_Search)
        self.settings_button1 = QPushButton("News Lookup\nResearch mode", self.history_text)
        self.settings_button1.setGeometry(30, 100, 300, 120)
        ...
        self.news_button.setGeometry(50, 260, 260, 120)
        ...
        health_button.setGeometry(50, 420, 260, 80)
        ...
        education_button.setGeometry(50, 540, 260, 80)
        ...
        exit_button.setGeometry(50, 420, 260, 80)
        ...
        exit_button.setGeometry(50, 540, 260, 80)
        exit_button.setFont(QFont("Helvetica", 32))
    ...
    def init_ai(self) :
        response = QMessageBox.question(
                self,
                "Activate AI",
                "Do you want to activate the Onboard AI?",
                QMessageBox.Yes | QMessageBox.No
            )         
        
        if response == QMessageBox.Yes:
            self.voice_handler.startlistening()
